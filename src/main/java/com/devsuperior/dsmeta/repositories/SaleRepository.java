...
public interface SaleRepository extends JpaRepository<Sale, Long> {
    ...
    Page<SaleReportDTO> search(LocalDate minDate, LocalDate maxDate, String name, Pageable pageable);
    ...
    List<SaleSummaryDTO> search2(LocalDate minDate, LocalDate maxDate);
}
